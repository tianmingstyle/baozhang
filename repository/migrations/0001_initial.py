# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2019-01-15 14:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctime', models.DateField(auto_now_add=True, verbose_name='cte time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'wait_to_process'), (2, 'processing'), (3, 'finish to process')], verbose_name='zhuangtai')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=32, verbose_name='biaoti')),
                ('suffix', models.CharField(max_length=32, verbose_name='houzui')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('feels', models.IntegerField(choices=[(1, 'yes'), (2, 'no')], verbose_name='Ding or Cai')),
        ...
        migrations.AddField(
            model_name='baozhang',
            name='processor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pbzd', to='repository.User'),
        ),
        migrations.AddField(
            model_name='baozhang',
            name='uid',
